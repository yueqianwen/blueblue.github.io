/****************************/
//全局通用变量
var global_now_uilanguage = 'en_rus';//界面语言
var global_def_rulelanguage = ['en_rus'];//['zh_rcn','mn_rcn','en_rus'];//规则内容语言
var global_def_desclanguage = ['zh_rus'];//['zh_rcn','mn_rcn','en_rus'];//规则描述语言
